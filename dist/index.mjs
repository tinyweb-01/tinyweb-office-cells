...
var Font, Fill, Border, BorderType, Borders, Alignment, _NumberFormat, NumberFormat, Protection, Style;
var init_Style = __esm({
  "src/styling/Style.ts"() {
    ...
    BorderType = /* @__PURE__ */ ((BorderType2) => {
...
var DataValidationType, DataValidationOperator, DataValidationAlertStyle, DataValidationImeMode, DataValidation, DataValidationCollection;
var init_DataValidation = __esm({
  "src/features/DataValidation.ts"() {
    DataValidationType = /* @__PURE__ */ ((DataValidationType2) => {
    ...
    DataValidationOperator = /* @__PURE__ */ ((DataValidationOperator2) => {
    ...
    DataValidationAlertStyle = /* @__PURE__ */ ((DataValidationAlertStyle2) => {
    ...
    DataValidationImeMode = /* @__PURE__ */ ((DataValidationImeMode2) => {
    ...
    DataValidation = class _DataValidation {
    ...
    DataValidationCollection = class {
      constructor() {
        this._validations = [];
...
var ConditionalFormat, ConditionalFormatCollection;
...
var Hyperlink, HyperlinkCollection;
...
var HorizontalPageBreakCollection, VerticalPageBreakCollection;
...
var CELL_TYPE_STRING, CELL_TYPE_INLINE_STRING, CELL_TYPE_NUMBER, CELL_TYPE_BOOLEAN, CELL_TYPE_ERROR, ERROR_VALUES, EXCEL_EPOCH, MS_PER_DAY, CellValueHandler;
...
var ERRORS, _FormulaEvaluator, FormulaEvaluator;
var init_FormulaEvaluator = __esm({
  "src/features/FormulaEvaluator.ts"() {
    ...
    _FormulaEvaluator = class _FormulaEvaluator {
      ...
      _funcNow() {
        return CellValueHandler.dateToExcelSerial(/* @__PURE__ */ new Date());
      }
      _funcDate(args) {
        if (args.length < 3) return ERRORS.VALUE;
      ...
      _funcYear(args) {
        ...
        const dt = CellValueHandler.excelSerialToDate(serial);
...
var SheetProtection, SheetProtectionDictWrapper, Worksheet;
var init_Worksheet = __esm({
  "src/core/Worksheet.ts"() {
    ...
    SheetProtectionDictWrapper = class {
...
var TYPE_TO_XML, OPERATOR_TO_XML, ALERT_TO_XML, IME_TO_XML, DataValidationXmlSaver;
...
var TYPE_MAP, ConditionalFormatXmlSaver;
var init_XmlConditionalFormatSaver = __esm({
  "src/io/XmlConditionalFormatSaver.ts"() {
    ...
    ConditionalFormatXmlSaver = class {
      constructor(escapeXml6) {
        this._escapeXml = escapeXml6;
      }
      /**
...
var HyperlinkXmlLoader, HyperlinkXmlSaver, HyperlinkRelationshipWriter;
var init_XmlHyperlinkHandler = __esm({
  "src/io/XmlHyperlinkHandler.ts"() {
    init_Hyperlink();
    HyperlinkXmlLoader = class {
    ...
    HyperlinkRelationshipWriter = class {
...
var AutoFilterXmlSaver;
var init_XmlAutoFilterSaver = __esm({
  "src/io/XmlAutoFilterSaver.ts"() {
    AutoFilterXmlSaver = class {
...
var CommentXmlWriter, CommentXmlReader;
var init_CommentXml = __esm({
  "src/io/CommentXml.ts"() {
    CommentXmlWriter = class {
      /**
...
var XmlSaver, DEFAULT_THEME_XML;
    ...
    XmlSaver = class {
      ...
      _writeWorksheetXml(zip, worksheet, sheetNum) {
        ...
        if (worksheet.conditionalFormatting.count > 0) {
          const cfSaver = new ConditionalFormatXmlSaver(escapeXml5);
        ...
        if (worksheet.dataValidations.count > 0) {
          const dvXml = new DataValidationXmlSaver(escapeXml5).formatDataValidationsXml(worksheet.dataValidations);
...
var DefinedName, DefinedNameCollection;
...
var AutoFilterXmlLoader;
var init_XmlAutoFilterLoader = __esm({
  "src/io/XmlAutoFilterLoader.ts"() {
    init_AutoFilter();
    AutoFilterXmlLoader = class {
...
var ConditionalFormatXmlLoader;
var init_XmlConditionalFormatLoader = __esm({
  "src/io/XmlConditionalFormatLoader.ts"() {
    ConditionalFormatXmlLoader = class {
...
var TYPE_MAP2, OPERATOR_MAP, ALERT_STYLE_MAP, IME_MODE_MAP, DataValidationXmlLoader;
...
__export(Workbook_exports, {
  ...
  save_format_from_extension: () => save_format_from_extension
});
...
var SaveFormat, EXTENSION_FORMAT_MAP, save_format_from_extension, WorkbookProtection, WorkbookProperties, DocumentProperties, Workbook;
var init_Workbook = __esm({
  "src/core/Workbook.ts"() {
    ...
    init_XmlSaver();
    init_DefinedName();
    SaveFormat = /* @__PURE__ */ ((SaveFormat2) => {
    ...
    save_format_from_extension = saveFormatFromExtension;
    ...
    WorkbookProperties = class {
      constructor() {
        ...
        this.protection = new WorkbookProtection();
        /** Calculation mode */
        this.calcMode = "auto";
        /** Defined names collection */
        this.definedNames = new DefinedNameCollection();
...
export { Alignment, AutoFilter, AutoFilterXmlLoader, AutoFilterXmlSaver, Border, BorderType, Borders, CELL_TYPE_BOOLEAN, CELL_TYPE_ERROR, CELL_TYPE_NUMBER, CELL_TYPE_STRING, Cell, CellValueHandler, Cells, CommentXmlReader, CommentXmlWriter, ConditionalFormat, ConditionalFormatCollection, ConditionalFormatXmlLoader, ConditionalFormatXmlSaver, DataValidation, DataValidationAlertStyle, DataValidationCollection, DataValidationImeMode, DataValidationOperator, DataValidationType, DataValidationXmlLoader, DataValidationXmlSaver, DefinedName, DefinedNameCollection, DocumentProperties, Fill, FilterColumn, Font, FormulaEvaluator, HorizontalPageBreakCollection, Hyperlink, HyperlinkCollection, HyperlinkRelationshipWriter, HyperlinkXmlLoader, HyperlinkXmlSaver, NumberFormat, Protection, SaveFormat, SharedStringTable, SheetProtection, SheetProtectionDictWrapper, Style, VerticalPageBreakCollection, Workbook, WorkbookProperties, WorkbookProtection, Worksheet, XmlLoader, XmlSaver, saveFormatFromExtension, save_format_from_extension };
